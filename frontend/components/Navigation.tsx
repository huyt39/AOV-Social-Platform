...
import { Home, Users, Sword, MessageSquare, User as UserIcon, Settings, LogOut, UsersRound } from 'lucide-react';
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div className="hidden md:block absolute left-0 top-0 bottom-0 w-1 bg-gold-500 shadow-[0_0_10px_#f59e0b]"></div>
                )}
                ...
                {/* Label */}
                <span className={`text-[10px] md:text-sm font-bold tracking-wider md:font-display uppercase ${isActive ? 'text-gold-400' : ''}`}>
                  {item.label}
                </span>
